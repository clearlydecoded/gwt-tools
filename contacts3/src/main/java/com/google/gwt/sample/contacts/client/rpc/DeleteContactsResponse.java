...
/**
 * DeleteContactsResponse class represents a response to the TODO put class name here.
 * 
...
{
  /** Class version ID. */
  private static final long serialVersionUID = 2327075940559727703L;
   ...
   */
  public DeleteContactsResponse(List<ContactDetails> contactList)
  {
