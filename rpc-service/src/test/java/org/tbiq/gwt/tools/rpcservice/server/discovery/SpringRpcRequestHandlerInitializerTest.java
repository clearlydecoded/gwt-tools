...
/**
 * SpringRpcRequestHandlerInitializerTest class is the test class for
 * {@link SpringRpcRequestHandlerInitializer}.
 * 
 * @author Yaakov Chaikin (yaakov.chaikin@gmail.com)
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {"/test-context.xml" })
public class SpringRpcRequestHandlerInitializerTest
{
  @Autowired
  ...
  {
    SpringRpcRequestHandlerInitializer initializer = new SpringRpcRequestHandlerInitializer(
      springContext);
    initializer.initializeHandlers();
